...
open class GadgetFrameLayout @JvmOverloads constructor(
    ...
    init {
        context.withStyledAttributes(attrs, R.styleable.GadgetFrameLayout) {
            borderShader = getDrawable(R.styleable.GadgetFrameLayout_BorderShader)
            borderSize = getDimension(R.styleable.GadgetFrameLayout_BorderSize, borderSize)
            cornerGravity = getInt(R.styleable.GadgetFrameLayout_ClipCornerGravity, cornerGravity)
            cornerRadius = getDimension(R.styleable.GadgetFrameLayout_ClipCornerRadius, cornerRadius)
            getInt(R.styleable.GadgetFrameLayout_FitWindowInsets, SideGravity.N).let {
